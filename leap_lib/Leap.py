...
class Hand(Interface):
    ...
    if _newclass:grab_angle = _swig_property(LeapPython.Hand_grab_angle_get)
    __swig_getmethods__["pinch_distance"] = LeapPython.Hand_pinch_distance_get
    if _newclass:pinch_distance = _swig_property(LeapPython.Hand_pinch_distance_get)
...
class Device(Interface):
    ...
    if _newclass:is_smudged = _swig_property(LeapPython.Device_is_smudged_get)
    __swig_getmethods__["is_lighting_bad"] = LeapPython.Device_is_lighting_bad_get
    if _newclass:is_lighting_bad = _swig_property(LeapPython.Device_is_lighting_bad_get)
...
class FailedDevice(Interface):
    ...
    def is_valid(self): return LeapPython.FailedDevice_is_valid(self)
    __swig_getmethods__["invalid"] = lambda x: LeapPython.FailedDevice_invalid
    if _newclass:invalid = staticmethod(LeapPython.FailedDevice_invalid)
    def __eq__(self, *args): return LeapPython.FailedDevice___eq__(self, *args)
    def __ne__(self, *args): return LeapPython.FailedDevice___ne__(self, *args)
    __swig_getmethods__["pnp_id"] = LeapPython.FailedDevice_pnp_id_get
    if _newclass:pnp_id = _swig_property(LeapPython.FailedDevice_pnp_id_get)
    __swig_getmethods__["failure"] = LeapPython.FailedDevice_failure_get
    if _newclass:failure = _swig_property(LeapPython.FailedDevice_failure_get)
...
class FailedDeviceList(Interface):
    ...
    def __len__(self): return LeapPython.FailedDeviceList___len__(self)
    def __getitem__(self, *args): return LeapPython.FailedDeviceList___getitem__(self, *args)
    def append(self, *args): return LeapPython.FailedDeviceList_append(self, *args)
    __swig_getmethods__["is_empty"] = LeapPython.FailedDeviceList_is_empty_get
    if _newclass:is_empty = _swig_property(LeapPython.FailedDeviceList_is_empty_get)
    def __iter__(self):
      _pos = 0
      while _pos < len(self):
        yield self[_pos]
...
class Frame(Interface):
    ...
    if _newclass:raw_images = _swig_property(LeapPython.Frame_raw_images_get)
...
class Controller(Interface):
    ...
    def failed_devices(self): return LeapPython.Controller_failed_devices(self)
    ...
    def set_paused(self, *args): return LeapPython.Controller_set_paused(self, *args)
    def is_paused(self): return LeapPython.Controller_is_paused(self)
    ...
    if _newclass:raw_images = _swig_property(LeapPython.Controller_raw_images_get)
...
class Listener(_object):
    ...
    def on_service_change(self, *args): return LeapPython.Listener_on_service_change(self, *args)
    def on_device_failure(self, *args): return LeapPython.Listener_on_device_failure(self, *args)
    def on_log_message(self, *args): return LeapPython.Listener_on_log_message(self, *args)
    def __disown__(self):
        self.this.disown()
